 ...
 */
public class TrailerDataAdapter extends ArrayAdapter<TrailerData> {

    private int mFieldId = 0;
    private final LayoutInflater mInflater;
    private int mResource;

    public TrailerDataAdapter(Context context, int resource, int textViewResId, List<TrailerData> objects) {
    ...
    private View createViewFromResource(LayoutInflater inflater, int position, View convertView,
        ...
        TrailerData item = getItem(position);
        textView.setText(item.getTrailerName());
